...
export async function buildAgentAsTool(manager: AgentManager, cfg: AgentAsToolConfig): Promise<Tool | null> {
    ...
    const extractor = cfg.customOutputExtractor ?? ((output: unknown) => {
