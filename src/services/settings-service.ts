...
import { PluginSettingsSchema, DEFAULT_SETTINGS, type PluginSettings, type ProviderSettingsEntry } from '../types/settings';
...
export class SettingsService implements SettingsServiceApi {
    ...
    migrate(raw: unknown): PluginSettings {
        ...
        if (rProviders) {
            ...
            return { providers, activeProviderId: typeof r.activeProviderId === 'string' ? r.activeProviderId : undefined } as PluginSettings;
        }
